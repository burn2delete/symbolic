...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SYMBOLIC_CALLER", () => {
    process.env["SYMBOLIC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SYMBOLIC_CALLER", () => {
    process.env["SYMBOLIC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SYMBOLIC_CALLER", () => {
    process.env["SYMBOLIC_CALLER"] = "unknown"
