...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/SymbolicOS/symbolic.git")).toEqual({ owner: "SymbolicOS", repo: "symbolic" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/SymbolicOS/symbolic")).toEqual({ owner: "SymbolicOS", repo: "symbolic" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:SymbolicOS/symbolic.git")).toEqual({ owner: "SymbolicOS", repo: "symbolic" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:SymbolicOS/symbolic")).toEqual({ owner: "SymbolicOS", repo: "symbolic" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/SymbolicOS/symbolic.git")).toEqual({ owner: "SymbolicOS", repo: "symbolic" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/SymbolicOS/symbolic")).toEqual({ owner: "SymbolicOS", repo: "symbolic" })
})
