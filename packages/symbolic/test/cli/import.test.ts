...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://symbolic.computer/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://symbolic.computer/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://symbolic.computer/share/")).toBeNull()
  expect(parseShareUrl("https://symbolic.computer/share/id/extra")).toBeNull()
