...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    compile: {
      ...
      outfile: `dist/${name}/bin/symbolic`,
    ...
    define: {
      ...
      SYMBOLIC_WORKER_PATH: workerPath,
      SYMBOLIC_CHANNEL: `'${Script.channel}'`,
      SYMBOLIC_LIBC: item.os === "linux" ? `'${item.abi ?? "glibc"}'` : "",
    },
  })
...
if (Script.release) {
  ...
  if (process.env.SYMBOLIC_PUBLISH_CLI_ASSETS !== "false") {
