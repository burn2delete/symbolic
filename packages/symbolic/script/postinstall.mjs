...
function symlinkBinary(sourcePath, binaryName) {
  ...
  console.log(`symbolic binary symlinked: ${targetPath} -> ${sourcePath}`)
...
async function main() {
  try {
    ...
    const target = path.join(__dirname, "bin", ".symbolic")
    ...
    console.error("Failed to setup symbolic binary:", error.message)
    process.exit(1)
  }
}
