...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "url='https://github.com/SymbolicOS/symbolic'",
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('symbolic')",
    "conflicts=('symbolic')",
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/SymbolicOS/symbolic/releases/download/v\${pkgver}\${_subver}/symbolic-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/SymbolicOS/symbolic/releases/download/v\${pkgver}\${_subver}/symbolic-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    `  homepage "https://github.com/SymbolicOS/symbolic"`,
    ...
    `      url "https://github.com/SymbolicOS/symbolic/releases/download/v${Script.version}/symbolic-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/SymbolicOS/symbolic/releases/download/v${Script.version}/symbolic-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "symbolic"',
    ...
    `      url "https://github.com/SymbolicOS/symbolic/releases/download/v${Script.version}/symbolic-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "symbolic"',
    "      end",
    ...
    `      url "https://github.com/SymbolicOS/symbolic/releases/download/v${Script.version}/symbolic-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "symbolic"',
    "      end",
