...
export namespace Question {
  ...
  interface State {
    pending: Map<QuestionID, Pending>
  }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@symbolic-agent/Question") {}
    ...
    Effect.gen(function* () {
      const state = yield* InstanceState.make<State>(
        Effect.fn("Question.state")(function* () {
          const state = {
            pending: new Map<QuestionID, Pending>(),
          }
