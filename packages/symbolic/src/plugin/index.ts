import type { Hooks, PluginInput, Plugin as PluginInstance } from "@symbolic-ai/plugin"
...
import { CodexRuntimePlugin } from "@symbolic-ai/codex-runtime"
...
export namespace Plugin {
  ...
  const state = Instance.state(async () => {
    ...
    for (let plugin of plugins) {
      ...
      if (plugin.includes("symbolic-openai-codex-auth") || plugin.includes("symbolic-copilot-auth")) continue
