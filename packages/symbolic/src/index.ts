...
import { LoginCommand, LogoutCommand, SwitchCommand, OrgsCommand, OpenCommand } from "./cli/cmd/account"
...
let cli = yargs(hideBin(process.argv))
  ...
  .middleware(async (opts) => {
    ...
    Log.Default.info("symbolic", {
      version: Installation.VERSION,
      args: process.argv.slice(2),
    })

    const marker = path.join(Global.Path.data, "symbolic.db")
