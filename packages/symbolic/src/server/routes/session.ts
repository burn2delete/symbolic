  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Symbolic sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      async (c) => {
        return c.json(Object.fromEntries(await SessionStatus.list()))
      },
    )
    .get(
      "/:sessionID",
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Symbolic session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Symbolic session for interacting with AI assistants and managing conversations.",
