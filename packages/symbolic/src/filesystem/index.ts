...
export namespace AppFileSystem {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@symbolic-agent/FileSystem") {}
  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const findUp = Effect.fn("FileSystem.findUp")(function* (target: string, start: string, stop?: string) {
        ...
        let current = start
        while (true) {
          const file = join(current, target)
          if (yield* fs.exists(file)) out.push(file)
      ...
      const globUp = Effect.fn("FileSystem.globUp")(function* (pattern: string, start: string, stop?: string) {
        ...
        let current = start
        while (true) {
          const items = yield* glob(pattern, { cwd: current, absolute: true, include: "file", dot: true }).pipe(
  ...
  export const normalizePath = Filesystem.normalizePath
  export const resolve = Filesystem.resolve
