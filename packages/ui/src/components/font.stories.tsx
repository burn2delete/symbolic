...
const docs = `### Overview
Loads Symbolic typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Symbolic Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Symbolic Mono Sample</div>
    </div>
  ),
}
