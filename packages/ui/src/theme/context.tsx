...
const STORAGE_KEYS = {
  THEME_ID: "symbolic-theme-id",
  COLOR_SCHEME: "symbolic-color-scheme",
  THEME_CSS_LIGHT: "symbolic-theme-css-light",
  THEME_CSS_DARK: "symbolic-theme-css-dark",
} as const

const THEME_STYLE_ID = "symbolic-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("symbolic-theme-preload")?.remove()
