...
สร้าง `.symbolic/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Symbolic:
...
- ระดับผู้ใช้ (Global): `~/.config/symbolic/commands/`
- ระดับโปรเจ็กต์: `.symbolic/commands/`
...
Symbolic มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
