...
Erstellen Sie `.symbolic/commands/test.md`:

```md title=".symbolic/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Symbolic-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Symbolic [config](/docs/config):

```json title="symbolic.jsonc" {4-12}
{
...
- Global: `~/.config/symbolic/commands/`
- Pro Projekt: `.symbolic/commands/`

```markdown title="~/.config/symbolic/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".symbolic/commands/component.md"
---
...
```md title=".symbolic/commands/create-file.md"
---
...
```md title=".symbolic/commands/analyze-coverage.md"
---
...
```md title=".symbolic/commands/review-changes.md"
---
...
```md title=".symbolic/commands/review-component.md"
---
...
Symbolic enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
