---
title: SDK
description: Typsicherer JS-Client fuer den symbolic-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das symbolic JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und symbolic programmatisch steuern.
...
Erstelle eine symbolic-Instanz:
...
`symbolic.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn symbolic bereits laeuft, kannst du nur einen Client erstellen und verbinden:
