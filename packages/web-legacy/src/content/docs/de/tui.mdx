---
title: TUI
description: Arbeite mit Symbolic in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Symbolic bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Symbolic die TUI im aktuellen Verzeichnis.
...
In der Symbolic-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Symbolic hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Symbolic. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `symbolic.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `SYMBOLIC_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
