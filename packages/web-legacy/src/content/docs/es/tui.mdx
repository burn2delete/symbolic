---
title: TUI
description: Usando la interfaz de usuario del terminal Symbolic.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Symbolic proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Symbolic se inicia TUI para el directorio actual.
...
Cuando utilice Symbolic TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Symbolic. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Symbolic. _Alias_: `/quit`, `/q`
...
Esto es independiente de `symbolic.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `SYMBOLIC_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
