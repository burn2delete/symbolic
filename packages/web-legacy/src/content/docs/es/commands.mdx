...
Crear `.symbolic/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Symbolic o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Symbolic [config](/docs/config):
...
- Por proyecto: `.symbolic/commands/`
...
symbolic incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
