---
title: Özel Araçlar
description: LLM'un symbolic'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. symbolic'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.symbolic/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/symbolic/tools/` içine yerleştirerek.
