...
description: symbolic dile özgü biçimlendiriciler kullanır.
---

symbolic, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

symbolic, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, symbolic bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

symbolic bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri symbolic yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
