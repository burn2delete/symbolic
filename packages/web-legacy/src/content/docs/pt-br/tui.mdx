---
title: TUI
description: Usando a interface de usuário de terminal symbolic.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O symbolic fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar symbolic inicia o TUI para o diretório atual.
...
Ao usar o TUI do symbolic, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao symbolic. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do symbolic. _Aliases_: `/quit`, `/q`
...
Isso é separado do `symbolic.json`, que configura o comportamento do servidor/runtime.
...
Use `SYMBOLIC_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
