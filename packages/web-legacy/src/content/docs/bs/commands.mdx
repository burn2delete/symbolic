...
Kreiraj `.symbolic/commands/test.md`:
...
Možete dodati prilagođene komande kroz Symbolic konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Symbolic [config](/docs/config):
...
- Globalno: `~/.config/symbolic/commands/`
- Po projektu: `.symbolic/commands/`
...
Symbolic uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
