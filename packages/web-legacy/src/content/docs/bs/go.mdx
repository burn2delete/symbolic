...
Symbolic Go je povoljna pretplata od **$10/mjesečno** koja vam daje pouzdan pristup popularnim otvorenim modelima kodiranja.

:::note
Symbolic Go je trenutno u beta fazi.
:::

Go funkcioniše kao bilo koji drugi pružatelj usluga u Symbolic-u. Pretplatite se na Symbolic Go i
...
:::tip
Testirali smo odabranu grupu modela i pružatelja usluga koji dobro rade sa Symbolic-om.
:::
...
Symbolic Go vam daje pristup ovim modelima za **$10/mjesečno**.

---

## Kako to funkcioniše

Symbolic Go funkcioniše kao bilo koji drugi pružatelj usluga u Symbolic-u.

1. Prijavite se na **<a href={console}>Symbolic Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite `/connect` komandu u TUI-ju, odaberite `Symbolic Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih putem Go.

:::note
Samo jedan član po radnom prostoru se može pretplatiti na Symbolic Go.
:::
...
Symbolic Go je pretplatnički plan od **$10/mjesečno**. Ispod su cijene **po 1M tokena**.
...
koristi format `symbolic-go/<model-id>`. Na primjer, za Kimi K2.5, biste
koristili `symbolic-go/kimi-k2.5` u vašoj konfiguraciji.
...
4. Nemamo **zaključavanja (lock-in)** omogućavajući vam da koristite bilo kojeg drugog pružatelja usluga sa Symbolic-om također.
