---
title: TUI
description: Korištenje korisničkog interfejsa Symbolic terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Symbolic pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Symbolic pokreće TUI za trenutni direktorij.
...
Kada koristite Symbolic TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Symbolic. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Symbolic. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `symbolic.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `SYMBOLIC_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
