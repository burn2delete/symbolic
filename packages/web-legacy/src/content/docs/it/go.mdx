...
Symbolic Go è un abbonamento a basso costo — **5 $ per il primo mese**, poi **10 $/mese** — che ti offre un accesso affidabile ai popolari modelli di programmazione aperti.

:::note
Symbolic Go è attualmente in beta.
:::

Go funziona come qualsiasi altro provider in Symbolic. Ti abboni a Symbolic Go e
...
Symbolic Go ti dà accesso a questi modelli a **5 $ per il primo mese**, poi a **10 $/mese**.
...
1. Accedi a **<a href={console}>Symbolic Zen</a>**, ti abboni a Go e
   copi la tua chiave API.
2. Esegui il comando `/connect` nella TUI, selezioni `Symbolic Go` e incolli
   la tua chiave API.
...
Il [model id](/docs/config/#models) nella tua Symbolic config
utilizza il formato `symbolic-go/<model-id>`. Ad esempio, per Kimi K2.5, useresti
`symbolic-go/kimi-k2.5` nella tua configurazione.
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con Symbolic.
