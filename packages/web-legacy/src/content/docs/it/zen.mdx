...
Zen funziona come qualunque altro provider in Symbolic. Accedi a Symbolic Zen e ottieni la tua chiave API. È **completamente opzionale**: non devi usarlo per usare Symbolic.
...
Symbolic Zen e un gateway AI che ti dà accesso a questi modelli.
...
Il [model id](/docs/config/#models) nella config di Symbolic usa il formato `symbolic/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `symbolic/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su Symbolic per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
