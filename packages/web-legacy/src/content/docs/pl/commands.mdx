...
Utwórz `.symbolic/commands/test.md`:
...
Możesz zdefiniować polecenia w `symbolic.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji symbolic:
...
- Globalnie: `~/.config/symbolic/commands/`
- Na projekt: `.symbolic/commands/`
...
symbolic zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
