...
Der er to typer agenter i Symbolic; primære agenter og subagenter.
...
Symbolic leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Symbolic leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Symbolic leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `symbolic.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Symbolic modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Symbolic-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Symbolic-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Symbolic Zen](/docs/zen), vil du bruge `symbolic/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `symbolic models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/SymbolicOS/symbolic).
:::
