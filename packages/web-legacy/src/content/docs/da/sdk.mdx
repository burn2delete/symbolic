...
Brug den til at bygge integrasjoner og kontrollere symbolic programmatisk.
...
Opret en forekomst av symbolic:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `symbolic.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av symbolic, kan du oprete en klientforekomst for at koble til den:
