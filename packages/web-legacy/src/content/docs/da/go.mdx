...
Symbolic Go er et billigt **$10/måned** abonnement, der giver dig pålidelig adgang til populære åbne kodningsmodeller.

:::note
Symbolic Go er i øjeblikket i beta.
:::

Go fungerer ligesom enhver anden udbyder i Symbolic. Du abonnerer på Symbolic Go og får din API-nøgle. Det er **helt valgfrit**, og du behøver ikke at bruge det for at bruge Symbolic.
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Symbolic.
:::
...
Symbolic Go giver dig adgang til disse modeller for **$10/måned**.

---

## Sådan fungerer det

Symbolic Go fungerer ligesom enhver anden udbyder i Symbolic.

1. Du logger ind på **<a href={console}>Symbolic Zen</a>**, abonnerer på Go, og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `Symbolic Go`, og indsætter din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over modeller, der er tilgængelige gennem Go.

:::note
Kun ét medlem pr. workspace kan abonnere på Symbolic Go.
:::
...
Symbolic Go inkluderer følgende grænser:
...
Symbolic Go er en **$10/måned** abonnementsplan. Nedenfor er priserne **pr. 1M tokens**.
...
[Model-id'et](/docs/config/#models) i din Symbolic-konfiguration bruger formatet `symbolic-go/<model-id>`. For eksempel, for Kimi K2.5, ville du bruge `symbolic-go/kimi-k2.5` i din konfiguration.
...
4. Have **ingen lock-in** ved at tillade dig også at bruge enhver anden udbyder med Symbolic.
