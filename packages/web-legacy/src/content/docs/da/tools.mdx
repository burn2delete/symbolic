...
Her er alle de innebygde verktøyene som er tilgængelige i Symbolic.
...
:::note
Dette verktøyet er bare tilgængelig når `SYMBOLIC_EXPERIMENTAL_LSP_TOOL=true` (eller `SYMBOLIC_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Symbolic-leverandøren eller når miljøvariabelen `SYMBOLIC_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
