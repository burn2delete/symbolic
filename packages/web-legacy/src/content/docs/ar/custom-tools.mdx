...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في symbolic.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في symbolic مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.symbolic/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/symbolic/tools/`.
