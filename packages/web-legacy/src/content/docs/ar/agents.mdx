...
يوجد نوعان من الوكلاء في Symbolic: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Symbolic مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Symbolic مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Symbolic مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `symbolic.json`:
...
- عام: `~/.config/symbolic/agents/`
- لكل مشروع: `.symbolic/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Symbolic القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Symbolic العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Symbolic الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Symbolic Zen](/docs/zen)، فستستخدم `symbolic/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `symbolic models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/SymbolicOS/symbolic).
:::
