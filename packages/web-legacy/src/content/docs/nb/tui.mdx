---
title: TUI
description: Bruke symbolic-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Symbolic gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Symbolic starter TUI for gjeldende katalog.
...
Når du bruker Symbolic TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Symbolic. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Symbolic. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `symbolic.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `SYMBOLIC_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
