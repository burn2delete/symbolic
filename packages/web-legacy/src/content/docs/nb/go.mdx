...
Symbolic Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
Symbolic Go er for tiden i beta.
:::
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer bra med Symbolic.
:::
...
Symbolic Go gir deg tilgang til disse modellene for **$10/måned**.
...
1. Du logger deg inn på **<a href={console}>Symbolic Zen</a>**, abonnerer på Go, og
...
:::note
Bare ett medlem per arbeidsområde kan abonnere på Symbolic Go.
:::
...
Symbolic Go er et **$10/måned** abonnementsplan. Nedenfor er prisene **per 1M tokens**.
...
bruker formatet `symbolic-go/<model-id>`. For eksempel, for Kimi K2.5, ville du
...
4. Ha **ingen innlåsing** ved å tillate deg å bruke hvilken som helst annen leverandør med Symbolic også.
