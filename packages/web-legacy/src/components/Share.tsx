...
import { IconSymbolic } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "symbolic/session/message-v2"
import type { Message } from "symbolic/session/message"
import type { Session } from "symbolic/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.symbolic_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.symbolic_name}>
                    <IconSymbolic width={16} height={16} />
                  </div>
