...
type PersistedWithReady<T> = [
  ...
  SetStoreFunction<T>,
  InitType,
  Accessor<boolean> & { promise: Promise<unknown> | undefined },
]
...
const GLOBAL_STORAGE = "symbolic.global.dat"
const LOCAL_PREFIX = "symbolic."
...
function workspaceStorage(dir: string) {
  ...
  return `symbolic.workspace.${head}.${sum}.dat`
}
...
export function persisted<T>(
  ...
  return [
    ...
    Object.assign(() => ready() === true, {
      promise: isAsync ? init : undefined,
    }),
  ]
}
