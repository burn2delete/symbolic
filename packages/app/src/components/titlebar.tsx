...
import { useTheme } from "@symbolic-ai/ui/theme"
  ...
  return (
    ...
    >
      ...
      <div class="min-w-0 flex items-center justify-center pointer-events-none">
        <div id="symbolic-titlebar-center" class="pointer-events-auto min-w-0 flex justify-center w-fit max-w-full" />
      </div>
      ...
      <div
        ...
        onMouseDown={drag}
      >
        <div id="symbolic-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
        <Show when={windows()}>
