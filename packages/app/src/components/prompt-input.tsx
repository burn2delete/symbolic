import { useFilteredList } from "@symbolic-agent/ui/hooks"
import { useSpring } from "@symbolic-agent/ui/motion-spring"
...
import { DockShellForm, DockTray } from "@symbolic-agent/ui/dock-surface"
import { Icon } from "@symbolic-agent/ui/icon"
import { ProviderIcon } from "@symbolic-agent/ui/provider-icon"
import { Tooltip, TooltipKeybind } from "@symbolic-agent/ui/tooltip"
import { IconButton } from "@symbolic-agent/ui/icon-button"
import { Select } from "@symbolic-agent/ui/select"
...
import { ImagePreview } from "@symbolic-agent/ui/image-preview"
...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const { addAttachments, addAttachment, removeAttachment, handlePaste } = createPromptAttachments({
    editor: () => editorRef,
