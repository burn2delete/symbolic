import { AppIcon } from "@symbolic-agent/ui/app-icon"
...
import { Keybind } from "@symbolic-agent/ui/keybind"
...
export function SessionHeader() {
  ...
  const centerMount = createMemo(() => document.getElementById("symbolic-titlebar-center"))
  const rightMount = createMemo(() => document.getElementById("symbolic-titlebar-right"))
