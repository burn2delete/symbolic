export const dict = {
  ...
  "dialog.provider.symbolic.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.symbolic.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.symbolicGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Symbolic",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Symbolic.",
  ...
  "provider.connect.symbolicZen.line1":
    "Symbolic Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.symbolicZen.visit.prefix": "Odwiedź ",
  "provider.connect.symbolicZen.visit.link": "symbolic.computer/zen",
  "provider.connect.symbolicZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Symbolic.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Symbolic.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w symbolic.json",
  ...
  "dialog.server.description": "Przełącz serwer Symbolic, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Symbolic ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Symbolic",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (symbolic.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Symbolic zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Symbolic",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Symbolic na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Symbolic ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Symbolic.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Symbolic",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Symbolic.",
