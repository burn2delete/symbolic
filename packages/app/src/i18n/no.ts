...
export const dict = {
  ...
  "dialog.provider.symbolic.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.symbolic.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.symbolicGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Symbolic",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Symbolic.",
  ...
  "provider.connect.symbolicZen.line1":
    "Symbolic Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.symbolicZen.visit.prefix": "Besøk ",
  "provider.connect.symbolicZen.visit.link": "symbolic.computer/zen",
  "provider.connect.symbolicZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Symbolic.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Symbolic.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i symbolic.json",
  ...
  "dialog.server.description": "Bytt hvilken Symbolic-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Symbolic ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Symbolic-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (symbolic.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Symbolic ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Symbolic inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Symbolic-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Symbolic",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Symbolic ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Symbolic skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Symbolic er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Symbolic starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Symbolic.",
