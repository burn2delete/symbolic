...
export const dict = {
  ...
  "dialog.provider.symbolic.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.symbolic.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.symbolicGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Symbolic tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Symbolic'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.symbolicZen.line1":
    "Symbolic Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.symbolicZen.visit.prefix": "",
  "provider.connect.symbolicZen.visit.link": "symbolic.computer/zen",
  "provider.connect.symbolicZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Symbolic'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Symbolic'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler symbolic.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Symbolic sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Symbolic'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Symbolic ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (symbolic.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Symbolic henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Symbolic ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Symbolic Masaüstü",
  ...
  "settings.desktop.wsl.description": "Symbolic sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Symbolic'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Symbolic'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Symbolic'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Symbolic'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Symbolic başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Symbolic'un en son sürümünü kullanıyorsunuz.",
