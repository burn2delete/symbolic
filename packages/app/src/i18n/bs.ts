export const dict = {
  ...
  "dialog.provider.symbolic.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.symbolic.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.symbolicGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Symbolic",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Symbolic-u.",
  ...
  "provider.connect.symbolicZen.line1":
    "Symbolic Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.symbolicZen.visit.prefix": "Posjeti ",
  "provider.connect.symbolicZen.visit.link": "symbolic.computer/zen",
  "provider.connect.symbolicZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Symbolic-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Symbolic-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u symbolic.json",
  ...
  "dialog.server.description": "Promijeni na koji se Symbolic server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Symbolic-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Symbolic timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (symbolic.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Symbolic još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Symbolic uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Symbolic server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Symbolic-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Symbolic izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Symbolic prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Symbolic-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Symbolic pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Symbolic-a.",
