export const dict = {
  ...
  "dialog.provider.symbolic.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.symbolic.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.symbolicGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Symbolic",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Symbolic.",
  ...
  "provider.connect.symbolicZen.line1":
    "Symbolic Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.symbolicZen.visit.prefix": "Visite ",
  "provider.connect.symbolicZen.visit.link": "symbolic.computer/zen",
  "provider.connect.symbolicZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Symbolic.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Symbolic.",
  ...
  "dialog.plugins.empty": "Plugins configurados em symbolic.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Symbolic este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Symbolic ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Symbolic",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (symbolic.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Symbolic ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Symbolic inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Symbolic dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Symbolic",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Symbolic aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Symbolic segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Symbolic é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Symbolic iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Symbolic.",
