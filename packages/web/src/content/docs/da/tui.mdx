---
title: TUI
description: Brug af Symbolic-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Symbolic giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Symbolic starter TUI for den nuværende mappe.
...
Når du bruger Symbolic TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Symbolic. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Symbolic. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `symbolic.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `SYMBOLIC_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
