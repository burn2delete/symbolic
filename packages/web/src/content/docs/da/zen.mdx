---
title: Zen
description: Udvalgt liste over modeller leveret af Symbolic.
---
...
Symbolic Zen er en liste over testede og verificerede modeller leveret af Symbolic-teamet.

:::note
Symbolic Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Symbolic. Du logger på Symbolic Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Symbolic.
:::
...
Symbolic Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Symbolic Zen fungerer som alle andre udbydere i Symbolic.

1. Du logger på **<a href={console}>Symbolic Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Symbolic Zen og indsætter API-nøglen.
...
| MiniMax M2.5 Gratis | minimax-m2.5-free  | `https://symbolic.computer/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://symbolic.computer/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://symbolic.computer/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://symbolic.computer/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://symbolic.computer/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i Symbolic-konfigurationen
bruger formatet `symbolic/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `symbolic/gpt-5.2-codex` i din konfiguration.
...
- MiniMax M2.5 Gratis er tilgængelig på Symbolic i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Symbolic i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede Symbolic Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Symbolic også.
