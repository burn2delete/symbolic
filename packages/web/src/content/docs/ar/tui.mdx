---
title: TUI
description: استخدام واجهة المستخدم TUI في Symbolic.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Symbolic واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Symbolic إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Symbolic في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Symbolic. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Symbolic. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Symbolic.
...
استخدم `SYMBOLIC_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
