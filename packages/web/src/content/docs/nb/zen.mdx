---
title: Zen
description: Utvalgt liste over modeller levert av Symbolic.
---
...
Symbolic Zen er en liste over testede og verifiserte modeller levert av Symbolic-teamet.

:::note
Symbolic Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i Symbolic. Du logger på Symbolic Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Symbolic.
:::
...
Symbolic Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Symbolic Zen fungerer som alle andre leverandører i Symbolic.

1. Du logger på **<a href={console}>Symbolic Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger Symbolic Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i Symbolic-konfigurasjonen
bruker formatet `symbolic/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `symbolic/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Symbolic i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Symbolic i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet Symbolic Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med Symbolic også.
