...
Agentferdigheter lar Symbolic oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går symbolic opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
symbolic viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `symbolic.json`:
