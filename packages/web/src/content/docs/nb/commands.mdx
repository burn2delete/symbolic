...
Opprett `.symbolic/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Symbolic-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Symbolic [config](/docs/config):
...
- Per prosjekt: `.symbolic/commands/`
...
Symbolic inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
