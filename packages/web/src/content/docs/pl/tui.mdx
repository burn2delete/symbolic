---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala symbolic.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

symbolic zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie symbolic uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI symbolic, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do symbolic. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij symbolic. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `symbolic.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `SYMBOLIC_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
