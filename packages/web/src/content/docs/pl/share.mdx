---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące symbolic.
---

Funkcja udostępniania symbolic umożliwia tworzenie publicznych linków do konwersacji symbolic, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, symbolic:

1. Tworzy unikalny publiczny adres URL sesji
2. Synchronizuje historię rozmów z naszymi serwerami
3. Udostępnia rozmowę za pośrednictwem łącza do udostępniania — `symbolic.computer/s/<share-id>`

---

## Udostępnianie

symbolic obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie symbolic korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `symbolic.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu symbolic w Twojej organizacji.
