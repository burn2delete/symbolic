...
`.symbolic/commands/test.md` oluştur:
...
symbolic işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

symbolic [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/symbolic/commands/`
- Proje başına: `.symbolic/commands/`
...
symbolic, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
