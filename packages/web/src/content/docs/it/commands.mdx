...
Crea `.symbolic/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Symbolic o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Symbolic:
...
- Globale: `~/.config/symbolic/commands/`
- Per progetto: `.symbolic/commands/`
...
symbolic include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
