export const dict = {
  ...
  "desktop.menu.help.documentation": "Symbolic Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Symbolic CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
