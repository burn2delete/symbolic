export const dict = {
  ...
  "desktop.menu.help.documentation": "Symbolic Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Symbolic CLI binary is missing. Try reinstalling the desktop app.",
