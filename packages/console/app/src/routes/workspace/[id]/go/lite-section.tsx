...
import { Database, eq, and, isNull } from "@symbolic-agent/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@symbolic-agent/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#symbolic-go")} target="_blank" rel="noopener noreferrer">
