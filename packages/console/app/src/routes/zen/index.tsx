...
import compareVideo from "../../asset/lander/symbolic-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/symbolic-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="symbolic:auth" content={loggedin() ? "true" : "false"} />
