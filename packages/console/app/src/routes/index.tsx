...
import video from "../asset/lander/symbolic-min.mp4"
import videoPoster from "../asset/lander/symbolic-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/symbolic</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
