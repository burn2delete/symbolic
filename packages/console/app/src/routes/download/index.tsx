...
import desktopAppIcon from "../../asset/lander/symbolic-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://symbolic.computer/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>symbolic.computer/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/symbolic")}>
                <code>
                  brew install <strong>anomalyco/tap/symbolic</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S symbolic")}>
                <code>
                  paru -S <strong>symbolic</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask symbolic-desktop")}>
                <code>
                  brew install --cask <strong>symbolic-desktop</strong>
                </code>
                <CopyStatus />
              </button>
