...
If unsure, choose the team or section with the most overlap with the issue and assign a member from that team at random.`,
  args: {
  ...
  async execute(args) {
    ...
    const zen = /\bzen\b/.test(text) || text.includes("symbolic black")
