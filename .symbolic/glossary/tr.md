...
- PR #15835: https://github.com/SymbolicOS/symbolic/pull/15835

## Do Not Translate (Locale Additions)

- `Symbolic` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `symbolic` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Symbolic` in prose, `symbolic` only for exact technical identifiers
...
- Avoid changing `symbolic` to `Symbolic` inside commands, URLs, package names, or code literals
