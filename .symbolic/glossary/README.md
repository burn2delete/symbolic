...
Use this folder for locale-specific translation guidance that supplements `.symbolic/agent/translator.md`.
...
- PR #12345: https://github.com/SymbolicOS/symbolic/pull/12345

## Do Not Translate (Locale Additions)

- `Symbolic` (preserve casing)
