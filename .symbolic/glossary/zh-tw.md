...
- PR #13942: https://github.com/SymbolicOS/symbolic/pull/13942

## Do Not Translate (Locale Additions)

- `Symbolic` (preserve casing in prose; keep `symbolic` only when it is part of commands, package names, paths, or code)
- `Symbolic Zen`
- `Symbolic CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `symbolic` in prose when referring to the product name; use `Symbolic`
