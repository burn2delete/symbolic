...
- PR #10018: https://github.com/SymbolicOS/symbolic/pull/10018
- PR #12935: https://github.com/SymbolicOS/symbolic/pull/12935

## Do Not Translate (Locale Additions)

- `Symbolic` (preserve casing in prose; keep `symbolic` only in commands, package names, paths, or code)
- `Symbolic CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
